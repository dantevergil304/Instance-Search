...
def extract_database_faces_features(model, root_frames_folder, root_faces_folder, root_feature_folder, start_video, end_video):
    '''
    ...
    for videoId in range(start_video, end_video):
...
if __name__ == '__main__':
    ...
    start_video = block_id * BLOCK_SIZE
    end_video = start_video + BLOCK_SIZE
    ...
    default_feature_folder = '../features/test_feat/'
    faces_folder = '../data/processed_data/all_faces/'
    frames_folder = '../data/processed_data/all_frames/'
    ...
    extract_database_faces_features(
        model, frames_folder, faces_folder, default_feature_folder, start_video, end_video)
